...
import { Dumbbell, Phone, MapPin, MessageCircle } from 'lucide-react';
    ...
    <footer id="contatos" className="footer-wrapper">
      ...
      <div className="footer-main">
        <div className="container footer-grid">
          ...
          <div className="footer-col">
            ...
            <p className="footer-brand-desc">
              Centro de treinamento de alta performance com Musculação, Jiu-Jitsu e Muay Thai, além de metodologia comprovada para o seu resultado.
            </p>
            {/*
          ...
          <div className="footer-col">
            ...
            <div className="social-links">
              <a
                ...
                aria-label="Instagram da Academia Forma Fitness"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="social-btn"
                aria-label="Facebook da Academia Forma Fitness"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="social-btn"
                aria-label="WhatsApp da Academia Forma Fitness"
              >
        ...
        <div className="container footer-bottom">
          <p>© {new Date().getFullYear()} Academia Forma Fitness. Todos os direitos reservados.</p>
